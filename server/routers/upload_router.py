...
def upload_single_image(file: UploadFile = File(...)):
...
def upload_multiple_images(files: List[UploadFile] = File(...)):
    """批量上传多张图片，常用于附图批量上传"""
...
def preview_image(path: str = Query(..., description="图片相对路径或文件名")):
    """
