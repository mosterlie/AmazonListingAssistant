...
class ProductCreateSchema(BaseModel):
    ...
    product_identifier: Optional[str] = Field("", description="商品标识 (标题翻译内容提炼成的一个中文词)")
    title_translation: Optional[str] = Field("", description="标题翻译 (商品标题的中文翻译)")
    identifier_translation: Optional[str] = Field("", description="商品标识翻译 (商品标识的英文翻译)")
